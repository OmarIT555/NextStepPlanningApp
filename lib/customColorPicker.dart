  ...
  class _MyCustomColorPickerState extends State<MyCustomColorPicker> {
    ...
    /***
     * The purpose of page is to give choices to the user in the Task Detail page under colors.
     * This feature will allow the user to choose any of the following colors when creating tasks.
     */
